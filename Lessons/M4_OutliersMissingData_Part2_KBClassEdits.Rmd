...
# Should always start with additiive
...
add_trend <- decompose_wind_add$trend
add_seasonal <- decompose_wind_add$seasonal
add_random <- decompose_wind_add$random

mult_trend <- decompose_wind_mult$trend
mult_seasonal <- decompose_wind_mult$seasonal
mult_random <- decompose_wind_mult$random

#Ex3: Create one data frame with all three vector and the Date columns from wind_data
df_add <- data.frame(date=wind_data$DATE, trend=add_trend, seasonal=add_seasonal, random=add_random)
df_mult <- data.frame(date=wind_data$DATE, trend=mult_trend, seasonal=mult_seasonal, random=mult_random)
